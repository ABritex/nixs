...
const Masonry: React.FC<MasonryProps> = ({
    ...
    const getRef = useCallback((id: string) => (el: HTMLDivElement | null) => {
        if (el) {
    ...
    const handleMouseEnter = useCallback((_id: string, element: HTMLElement) => {
        if (scaleOnHover) {
    ...
    const handleMouseLeave = useCallback((_id: string, element: HTMLElement) => {
        if (scaleOnHover) {
        ...
        <div ref={containerRef} className="relative w-full h-full">
            {grid.map((item, index) => (
                <div
                    ...
                    onClick={() => !renderItem && window.open(item.url, '_blank', 'noopener')}
