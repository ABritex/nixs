    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            <input type={type} placeholder={placeholder} value={value} required={required}
                ...
                className={`w-full rounded-xl border bg-background/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/30 outline-none transition-all duration-150 ${
                    error
