...
export const TECH_CATEGORIES = [
...

    {
        ...
        techs: [
            ...
            { name: "Prisma", level: "Familiar", note: "ORM, schema modeling", icon: "/icons/prisma-svgrepo-com.svg", iconClassName: "dark:invert" },
...

    {
        ...
        techs: [
            ...
            { name: "Vercel", level: "Proficient", note: "CI/CD, edge functions", icon: "/icons/vercel.svg", iconClassName: "dark:invert" },
            { name: "Railway", level: "Familiar", note: "Deployments, hosting", icon: "/icons/railway.svg", iconClassName: "dark:invert" },
...
export const TOOLS = [
    ...
    { name: "GitHub", tag: "vcs", color: "text-foreground", icon: "/icons/github.svg", iconClassName: "dark:invert" },
...
export const WANT_TO_LEARN = [
    { name: "Rust", tag: "systems programming", color: "text-secondary", icon: "/icons/rust.svg", iconClassName: "dark:invert" },
...
export const PROJECTS = [
    ...
    },
    {
        ...
        dot: "bg-[#BA7517]",
        fallbackIcon: "🎵",
        techs: ["React", "Tailwind CSS", "TanStack", "TypeScript", "Discord.js", "Drizzle ORM", "Neon DB"],
    ...
    },
    {
        ...
        desc: "Live2D AI VTuber that reads YouTube chat and responds in real-time. Inspired by Neuro-sama — Python-powered, with live TTS and expressive avatar reactions.",
        period: "2022",
        cover: placeholderCover,
        logo: placeholderLogo,
        dot: "bg-[#E879F9]",
        fallbackIcon: "✨",
        techs: ["Python", "TensorFlow", "PyTorch", "Live2D", "YouTube API", "TTS", "Ollama", "Docker"],
        liveUrl: null,
        githubUrl: null,
    },
    {
