                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-center">
                        ...
                        <div ref={ctaRef} className="flex flex-wrap items-center gap-3 pt-2">
                            {SOCIALS.map((s) => (
                                <a key={s.label} href={s.url} target="_blank" rel="noopener noreferrer"
                                    className="btn-pop cursor-target w-10 h-10 flex items-center justify-center rounded-full border border-border bg-card text-muted-foreground hover:text-foreground hover:border-accent/50 transition-all"
                                    aria-label={s.label}
                                >
                            ...
                            <a href="/resume.pdf" download
                                className="btn-pop cursor-target ml-2 px-5 py-2.5 rounded-full bg-primary text-primary-foreground text-[11px] font-semibold tracking-wide hover:opacity-90 transition-all"
                            >
                                Download Resume
                            </a>
                        </div>
                    ...
                    <div ref={imgRef} className="lg:col-span-2 flex justify-center lg:justify-end">
                        <BorderGlow
                            ...
                            className="w-[260px] h-[380px] md:w-[300px] md:h-[420px]"
                        >
